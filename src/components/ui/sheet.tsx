  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          // `h-dvh` (100dvh) — dynamic viewport height — adjusts to mobile
          // browser chrome (URL bar / toolbar) that shrinks/grows on scroll.
          // `h-full` would be 100% of the body, but body becomes position:fixed
          // (= viewport height) when locked, so h-dvh is more correct + stable.
          // `overflow-y-auto` lets the inner list (cart items / menu) scroll
          // independently from the locked background page.
