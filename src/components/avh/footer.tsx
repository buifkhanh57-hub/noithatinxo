      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 px-4 py-10 md:grid-cols-4 lg:grid-cols-5">
        <div className="md:col-span-2">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {facebook && (
              <a href={facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="flex h-9 w-9 items-center justify-center rounded-full border hover:border-primary/30 hover:bg-primary/10 hover:text-primary"><Facebook className="h-4 w-4" /></a>
            )}
            {zalo && (
              <a href={zaloHref} target="_blank" rel="noopener noreferrer" aria-label="Zalo" className="flex h-9 w-9 items-center justify-center rounded-full border text-xs font-bold hover:border-primary/30 hover:bg-primary/10 hover:text-primary">Zalo</a>
            )}
            {instagram && (
              <a href={instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex h-9 w-9 items-center justify-center rounded-full border hover:border-primary/30 hover:bg-primary/10 hover:text-primary"><Instagram className="h-4 w-4" /></a>
            )}
            {youtube && (
              <a href={youtube} target="_blank" rel="noopener noreferrer" aria-label="Youtube" className="flex h-9 w-9 items-center justify-center rounded-full border hover:border-primary/30 hover:bg-primary/10 hover:text-primary"><Youtube className="h-4 w-4" /></a>
            )}
            {tiktok && (
              <a href={tiktok} target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="flex h-9 w-9 items-center justify-center rounded-full border text-xs font-bold hover:border-primary/30 hover:bg-primary/10 hover:text-primary">TT</a>
            )}
          </div>
        </div>
